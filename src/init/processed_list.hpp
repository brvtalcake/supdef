...
GLOBAL_DEF_START(std::vector<shared_ptr<const stdfs::path>>, already_processed_files)
    already_processed_files.reserve(32);
GLOBAL_DEF_END(std::vector<shared_ptr<const stdfs::path>>, already_processed_files)
